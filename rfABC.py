...
data_file = "DATA/synthetic_dif_2ABC_500.csv"
...
clf = RandomForestClassifier(class_weight='balanced', random_state=seed, criterion=crit, max_depth=depth, n_estimators=10)  # Use RandomForestClassifier
...
importance_df.to_csv(data_file.replace(".csv", f"_rf_{seed}_{crit}_{depth}.csv"), index=False)