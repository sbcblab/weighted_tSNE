...
dataset_file   = "DATA/synthetic_dif_3ABC_500.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
weights_file   = [
                #"DATA/synthetic_dif_2ABC_500_rf_1_gini_None.csv",
                # "DATA/synthetic_dif_2ABC_500_rf_2_gini_None.csv",
                # "DATA/synthetic_dif_2ABC_500_rf_3_gini_None.csv",
                #"DATA/synthetic_dif_2ABC_500_rf_4_gini_None.csv",
                # "DATA/synthetic_dif_2ABC_500_rf_5_gini_None.csv",
                #"DATA/synthetic_dif_2ABC_500_rf_6_gini_None.csv",
                 "DATA/synthetic_dif_2ABC_500_rf_7_gini_None.csv",
                # "DATA/synthetic_dif_2ABC_500_rf_8_gini_None.csv",
                #   "DATA/synthetic_dif_2ABC_500_rf_9_gini_None.csv",
                #   "DATA/synthetic_dif_2ABC_500_rf_10_gini_None.csv",
                # "DATA/synthetic_dif_2ABC_500_rf_11_gini_None.csv",
                #  "DATA/synthetic_dif_2ABC_500_rf_12_gini_None.csv",
                #  "DATA/synthetic_dif_2ABC_500_rf_13_gini_None.csv",
                #    "DATA/synthetic_dif_2ABC_500_rf_14_gini_None.csv",
                #   "DATA/synthetic_dif_2ABC_500_rf_15_gini_None.csv",
                # "DATA/synthetic_dif_2ABC_500_rf_16_gini_None.csv",
                # "DATA/synthetic_dif_2ABC_500_rf_17_gini_None.csv",
                # "DATA/synthetic_dif_2ABC_500_rf_18_gini_None.csv",
                # "DATA/synthetic_dif_2ABC_500_rf_19_gini_None.csv",
                #  "DATA/synthetic_dif_2ABC_500_rf_20_gini_None.csv",    
                 ]         
...
output_folder  = 'RESULTS/difABC3_500/'  # name of directory in which the results will be saved
fig_extension  = '.pdf'

task            = "classification" # "classification" or "regression"
class_label     = "target"          # label of the column with the classes or target values
