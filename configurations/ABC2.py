...
dataset_file   = "DATA/synthetic_dif_2ABC.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
weights_file   = [
                  "DATA/synthetic_dif_2ABC_dt.csv",   
                 ]         
...
output_folder  = 'RESULTS/difABC2/'  # name of directory in which the results will be saved
fig_extension  = '.pdf'
