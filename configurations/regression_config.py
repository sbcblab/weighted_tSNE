...
dataset_file   = "../RelAgg/DATA/DMDK/regression_4in100_1000.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
weights_file   = [
                  "DATA/selections/DMDK/RelAgg_0015_score_regression_4in100_1000.csv",
                  "DATA/selections/DMDK/RelAgg_0030_score_regression_4in100_1000.csv",
                  "DATA/selections/DMDK/RelAgg_0045_score_regression_4in100_1000.csv",
                  "DATA/selections/DMDK/RelAgg_0060_score_regression_4in100_1000.csv",
                  "DATA/selections/DMDK/RelAgg_0075_score_regression_4in100_1000.csv",
                  "DATA/selections/DMDK/RelAgg_0090_score_regression_4in100_1000.csv",
                  "DATA/selections/DMDK/RelAgg_0105_score_regression_4in100_1000.csv",
                  "DATA/selections/DMDK/RelAgg_0120_score_regression_4in100_1000.csv",
                  "DATA/selections/DMDK/RelAgg_0135_score_regression_4in100_1000.csv",
                  "DATA/selections/DMDK/RelAgg_0150_score_regression_4in100_1000.csv",    
                 ]         
...
output_folder  = 'RESULTS/DMDK2/regression/'  # name of directory in which the results will be saved
fig_extension  = '.pdf'
...
draw_legend         = True # if True plot the legend in the plot
