...
dataset_file   = "../RelAgg/DATA/DMDK/Prostate_GSE6919_U95C.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
weights_file   = [
                  "DATA/selections/DMDK/RelAgg_0020_score_Prostate_GSE6919_U95C.csv",
                  "DATA/selections/DMDK/RelAgg_0040_score_Prostate_GSE6919_U95C.csv",
                  "DATA/selections/DMDK/RelAgg_0060_score_Prostate_GSE6919_U95C.csv",
                  "DATA/selections/DMDK/RelAgg_0080_score_Prostate_GSE6919_U95C.csv",
                  "DATA/selections/DMDK/RelAgg_0100_score_Prostate_GSE6919_U95C.csv",
                  "DATA/selections/DMDK/RelAgg_0120_score_Prostate_GSE6919_U95C.csv",
                  "DATA/selections/DMDK/RelAgg_0140_score_Prostate_GSE6919_U95C.csv",
                  "DATA/selections/DMDK/RelAgg_0160_score_Prostate_GSE6919_U95C.csv",
                  "DATA/selections/DMDK/RelAgg_0180_score_Prostate_GSE6919_U95C.csv",
                  "DATA/selections/DMDK/RelAgg_0200_score_Prostate_GSE6919_U95C.csv",    
                 ]         
...
output_folder  = 'RESULTS/DMDK2/prostate/'  # name of directory in which the results will be saved
fig_extension  = '.pdf'
