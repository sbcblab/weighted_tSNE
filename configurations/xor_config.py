...
dataset_file   = "../RelAgg/DATA/DMDK/xor_2in50_500.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
weights_file   = [
                  "DATA/selections/DMDK/xor/RelAgg_0015_score_xor_2in50_500.csv",
                  "DATA/selections/DMDK/xor/RelAgg_0030_score_xor_2in50_500.csv",
                  "DATA/selections/DMDK/xor/RelAgg_0045_score_xor_2in50_500.csv",
                  "DATA/selections/DMDK/xor/RelAgg_0060_score_xor_2in50_500.csv",
                  "DATA/selections/DMDK/xor/RelAgg_0075_score_xor_2in50_500.csv",
                  "DATA/selections/DMDK/xor/RelAgg_0090_score_xor_2in50_500.csv",
                  "DATA/selections/DMDK/xor/RelAgg_0105_score_xor_2in50_500.csv",
                  "DATA/selections/DMDK/xor/RelAgg_0120_score_xor_2in50_500.csv",
                  "DATA/selections/DMDK/xor/RelAgg_0135_score_xor_2in50_500.csv",
                  "DATA/selections/DMDK/xor/RelAgg_0150_score_xor_2in50_500.csv",    
                 ]         
...
output_folder  = 'RESULTS/DMDK2/xornew/'  # name of directory in which the results will be saved
fig_extension  = '.pdf'
