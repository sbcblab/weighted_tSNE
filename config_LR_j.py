...
dataset_file   = "DATA/juliano/LR_j.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
weights_file   = "DATA/selections/Lasso_score_LR_j.csv"
...
output_folder  = 'JULIANO/LR/'        # name of directory in which the results will be saved
