...
dataset_file   = "DATA/datasets/synth_100samples_5000features_50informative.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
weights_file   = "DATA/selections/Perfect.csv"
...
output_folder  = 'TESE/SYNTH/'        # name of directory in which the results will be saved
