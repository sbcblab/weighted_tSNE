...
dataset_file   = "DATA/datasets/Prostate_GSE6919_U95C.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
weights_file   = "DATA/selections2/SVMRFE_Prostate_GSE6919_U95C.csv"
...
output_folder  = 'TESE/parser/'        # name of directory in which the results will be saved
