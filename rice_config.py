...
dataset_file   = "../RelAgg/DATA/Rice_MSC_Dataset/rice.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
...
output_folder  = 'RESULTS/RICE/'  # name of directory in which the results will be saved
fig_extension  = '.png'
