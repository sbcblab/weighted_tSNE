...
weights_file   = ["DATA/selections/RelAgg_score_Breast_GSE59246.csv",  # list with paths to the files with the weights of each feature
                  ] 
...
title          = True # if True, print title, if False not
